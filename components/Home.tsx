...
export default function Home({ fadeIn }: HomeProps) {
  ...
  return (
    <div
      className={`font-jakarta bg-white text-gray-900 transition-opacity duration-700 ${fadeIn ? "opacity-100" : "opacity-0"}`}
    >
      <Navbar />
      ...
      <section className="bg-white pt-24 pb-16 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 block">
          <div className="absolute left-0 top-[28%] lg:top-[24%] -translate-y-1/2 -translate-x-10 w-[180px] lg:w-[260px] h-[280px] lg:h-[380px] overflow-hidden opacity-70">
            <Image
              src="/assets/kiri.svg"
          ...
          <div className="absolute right-0 top-[28%] lg:top-[24%] -translate-y-1/2 translate-x-10 w-[180px] lg:w-[260px] h-[280px] lg:h-[380px] overflow-hidden opacity-70">
            <Image
        ...
        <div className="max-w-4xl mx-auto px-6 text-center text-black relative z-10">
          <h1 className="text-3xl md:text-5xl font-serif font-bold leading-snug space-y-1">
            <span className="block">
              TRANSFORMING
              <span
                className="font-citadel italic font-normal"
                style={{ color: "#162E93" }}
              >
                {" "}
                Floral Dreams
          ...
          <div className="mt-8">
            <a
              href="#produk"
              className="px-6 py-3 transition text-white font-semibold rounded-full hover:opacity-80"
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-gray-600 text-[1rem]">
            ...
            <div className="mt-6 flex gap-4">
              <a
                href="#produk"
                className="px-7 py-3 text-white rounded-full font-semibold text-sm transition-all duration-300 hover:scale-105 active:scale-95"
                style={{ backgroundColor: "#162E93" }}
              >
                Lihat Koleksi
              </a>
              ...
              <a
                href="#order"
                className="px-7 py-3 border border-black text-black rounded-full font-semibold text-sm hover:bg-black hover:text-white transition-all duration-300 hover:scale-105 active:scale-95"
              >
                Pesan
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12 text-center">
            ...
            <div className="mt-4">
              <a
                href="#all-products"
                className="px-5 py-1.5 border text-sm rounded-full hover:text-white transition"
              ...
              currentProducts.map((item: Product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`transition-opacity duration-300 rounded-xl overflow-hidden ${isLoading ? "opacity-0" : "opacity-100"}`}
                    >
                      {mainImage && (
                        <Image
                    ...
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <a
                          href="#order"
                          className="mt-3 inline-block px-5 py-2 border rounded-full hover:text-white transition"
                          style={{ borderColor: "#162E93", color: "#162E93" }}
            ...
            <>
              <div className="flex justify-center items-center gap-3 mt-12">
                <button
                  ...
                  className="p-2 text-gray-500 disabled:opacity-30 disabled:cursor-not-allowed"
                  style={{ color: currentPage === 1 ? undefined : "#162E93" }}
                >
                  &lt;
                </button>
                ...
                <button
                  ...
                  className="p-2 text-gray-500 disabled:opacity-30 disabled:cursor-not-allowed"
                  style={{
                    color: currentPage === totalPages ? undefined : "#162E93",
                  }}
                >
                  &gt;
                </button>
      ...
      <section id="info" className="bg-gray-50 py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div
              className="bg-white border-2 rounded-xl p-10 text-center"
              style={{ borderColor: "#162E93" }}
            >
              <p
